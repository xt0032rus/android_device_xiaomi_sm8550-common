...
BOARD_HAS_CFG80211_KERNEL_CONFIG := true
...
WIFI_HIDL_FEATURE_CACHED_SCAN := true
WIFI_HIDL_FEATURE_AWARE := true
WIFI_DRIVER_DEFAULT_CACHED_SCAN_RESULT := false
WIFI_DRIVER_CACHED_SCAN_RESULT := false
